...
export const translations = {
  ...
  duration_3_days: '3 дня',
    ...
    aiGuideTitle: 'AI-Агент',
    aiGuideSubtitle: 'Умный помощник · проверенные данные',
  ...
  duration_3_days: '3 days',
    ...
    aiGuideTitle: 'AI Agent',
    aiGuideSubtitle: 'Smart concierge · curated knowledge',
    toolsTitle: 'Tools',
  ...
  duration_3_days: '3 күн',
    ...
    aiGuideTitle: 'AI-Агент',
    aiGuideSubtitle: 'Ақылды кеңесші · тексерілген дереккөздер',
    toolsTitle: 'Құралдар',
